  ...
  return(
    <div className='register'>
      <form onSubmit={handleSubmit} className='box-reg'>
        ...
        <hr className="hr-lastName"></hr>
        <label
          for="login"
          className='ln'>Логин</label>
        <div className='sing-ln'>
          <img src='/img/user_icon.svg' alt='user_icon'/>
          <input
        ...
        <hr className="hr-pass"></hr>
        <label
          for="second_pass"
          className='second_pass'>Повторите пароль</label>
        <div className='sing-second_pass'>
          <img src='/img/password_icon.svg' alt='password_icon'/>
          <input
        ...
        <hr className="hr-second_pass"></hr>
        ...
        <div className='login-btn'>
          <button onClick={() => props.onFormSwitch('login')}>Уже есть аккаунт</button>
        </div>  
      </form>
    </div>
  )
